...
/// (這個 widget 使用 [ChangeNotifierProvider] 來建立並提供 [TriggerPageProvider] 給它的子 widget 樹。
/// 實際的 UI 是由 [_TriggerPageView] widget 建立的。)
...
class __TriggerPageViewState extends State<_TriggerPageView> with AutomaticKeepAliveClientMixin {
  ...
  /// Handles the trigger mission button press, awaiting the result and showing a message.
  /// (處理觸發任務按鈕的點擊，等待結果並顯示訊息。)
