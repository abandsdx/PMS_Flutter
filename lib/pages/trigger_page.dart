...
class _TriggerPageState extends State<TriggerPage> {
  ...
  void initState() {
    super.initState();
    if (Config.fieldMap.isNotEmpty) {
      selectedField = Config.fieldMap.keys.first;
      fetchRobots();
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: "遞送目標點")),
                  TextFormField(
                      controller: pickupController,
                      decoration: const InputDecoration(labelText: "中途取貨地點")),
                  //TextFormField(
